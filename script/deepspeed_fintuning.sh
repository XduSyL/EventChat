...
deepspeed --include=localhost:0,1,2,3,4,5,6,7 /data/SyL/Event_RGB/deepspeed_train.py \
    ...
    --bf16 True \
    --output_dir /data/SyL/Event_RGB/checkpoints/EventChat-v1.5-7b-instruction-lora \
    --output_mm_mlp_adapter /data/SyL/Event_RGB/checkpoints/EventChat-v1.5-7b-instruction-lora \
    --num_train_epochs 4 \
